...
export default function Chat() {
  ...
  return (
    <div className="flex h-screen  text-white">
      <div className="bg-slate-800 w-1/3 px-2 pt-4 flex flex-col ">
              ...
              <div className="overflow-y-scroll  absolute top-0 left-0 right-0 bottom-2">
                {messagesWithoutDupes.map((message) => (
                  <div
                    key={message._id}
                    className={
                      message.sender === id ? "text-right mr-1 " : "text-left "
                    }
                  >
                    <div
                      className={
                    ...
                    >
                      ...
                      {message.file && (
                        <div className="">
                          <a
                            target="_blank"
                            className="undeline flex items-center gap-1 border-b"
                            href={
        ...
        {!!selectedUserId && (
          <form className="flex gap-2" onSubmit={sendMessage}>
            <input
              ...
              className="bg-slate-700 border p-2 flex-grow mx-2 rounded-sm mb-3"
            ...
            <button
              type="submit"
              className="  bg-cyan-500 p-2 mx-2 rounded-sm mb-3"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
